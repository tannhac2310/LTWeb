            ...
            <div action="signup" method="post" class="container" >
                <div class="row"><aside class="col-sm-3 hidden-xs" id="column-left">
                        <div class="list-group">
                            ...
                            <a class="list-group-item" href="login.jsp">Đăng nhập</a> 
                            <a class="list-group-item" href="#">Đăng ký</a> 
                    ...
                    <div class="col-sm-9" id="content">            <div class="breadcrumbs">
                        ...
                        <p> <small><strong class="define_note"></strong></small>Nếu bạn đã có tài khoản trước đó, vui lòng đặng nhập tại 
                            <a href="login.jsp">trang đăng nhập</a>.</p>
                        <form action="signup" method="post" class="form-horizontal">
                            <div class="contentText">  
                                <fieldset id="account">
                                    <p class="text-danger">${messageregister}</p>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="newUser" type="text" class="form-control" id="input-firstname" placeholder="Nhập tên tài khoản" required>
                                        </div>
                                    </div>
<!--                                    <div class="form-group required">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="newEmail" type="email" class="form-control" id="input-email" placeholder="Nhập địa chỉ Email" required>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label for="input-telephone" class="col-sm-2 control-label">Số điện thoại</label>
                                        <div class="col-sm-10">
                                            <input name="newTelephone" type="tel" class="form-control" id="input-telephone" placeholder="Nhập số điện thoại" required>
                                        </div>
                                    </div>
...
<!--                                <fieldset id="address">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="newPassword" type="password" class="form-control" id="input-password" placeholder="Mật khẩu" required>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label for="input-confirm" class="col-sm-2 control-label">Nhập lại mật khẩu</label>
                                        <div class="col-sm-10">
                                            <input name="newConfirm" type="password" class="form-control" id="input-confirm" placeholder="Nhập lại mật khẩu" required>
                                        </div>
                                    </div>
                                </fieldset>
<!--                                <fieldset>
                                ...
                                <div class="buttons">
                                    <div class="pull-right">Tôi đã đọc và đồng ý với <a class="agree" href="#"><b>các điều khoản sử dụng</b></a>                                                        <input type="checkbox" value="1" name="agree">
                                        &nbsp;
                                        <input type="submit" class="btn btn-primary reg_button" value="Tiếp tục" >
                                    </div>
                                </div>
                            </div>
                        </form>
